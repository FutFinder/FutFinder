...
- **Bloqueo:** U3 (inscripción y cupos por club) NO puede darse por terminada sin esto: su conteo por club se apoya en filas de `attendees` que hoy cualquiera puede insertar por su cuenta.
