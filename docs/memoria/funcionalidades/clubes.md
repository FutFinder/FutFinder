...
La ubicación del partido publicado está partida en dos: los integrantes de cualquiera de los dos clubes ven la dirección exacta, el mapa y «Cómo llegar»; el resto ve una ubicación aproximada de ~1 km, etiquetada como tal, con la que igual puede encontrar el partido en listas, mapa y filtros por zona. Ver [Seguridad y privacidad](../arquitectura/seguridad-y-privacidad.md).
