...
import ClubLineupScreen from '../screens/ClubLineupScreen';
import ClubHistoryScreen from '../screens/ClubHistoryScreen';
import ClubMatchCalendarScreen from '../screens/ClubMatchCalendarScreen';
...
const GuardedClubLineupScreen = withAuthGuard(ClubLineupScreen, 'ClubLineup');
const GuardedClubHistoryScreen = withAuthGuard(ClubHistoryScreen, 'ClubHistory');
const GuardedClubMatchCalendarScreen = withAuthGuard(ClubMatchCalendarScreen, 'ClubMatchCalendar');
    ...
    >
      ...
      >
        ...
        */}
        ...
        <Stack.Screen
          name="ClubLineup"
          component={GuardedClubLineupScreen}
          options={{ animation: 'slide_from_right' }}
        />
        <Stack.Screen
          name="ClubGallery"
        ...
        <Stack.Screen
          name="ClubHistory"
          component={GuardedClubHistoryScreen}
          options={{ animation: 'slide_from_right' }}
        />
        <Stack.Screen
          name="ClubMatchCalendar"
          component={GuardedClubMatchCalendarScreen}
          options={{ animation: 'slide_from_right' }}
        />
        <Stack.Screen
          name="ClubChallenge"
        ...
        <Stack.Screen
          name="ClubResult"
          component={GuardedClubResultScreen}
          options={{ animation: 'slide_from_bottom' }}
        />
        <Stack.Screen
          name="ExploreClubs"
        ...
        <Stack.Screen
          name="PermisosClub"
          component={GuardedPermisosClubScreen}
          options={{ animation: 'slide_from_bottom' }}
        />
        <Stack.Screen
          name="ClubInvite"
        ...
        <Stack.Screen
          name="MisReservas"
          component={GuardedMisReservasScreen}
          options={{ animation: 'slide_from_right' }}
        />
        <Stack.Screen
          name="PagoReserva"
        ...
        />
        <Stack.Screen
          name="InvitarJugadores"
          component={GuardedInvitarJugadoresScreen}
          options={{ animation: 'slide_from_right' }}
        />
        <Stack.Screen
        ...
        <Stack.Screen
          name="Tarifas"
          component={GuardedTarifasScreen}
          options={{ animation: 'slide_from_right' }}
        />
        <Stack.Screen
          name="Cobros"
